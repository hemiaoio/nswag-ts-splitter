...
namespace NJsonSchema.CodeGeneration.TypeScript.Models
{
    ...
    public class CustomPropertyModel : PropertyModelBase
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="CustomPropertyModel"/> class.</summary>
        ...
        public CustomPropertyModel(
            CustomClassTemplateModel classTemplateModel,
            JsonSchemaProperty property, string parentTypeName,
            CustomTypeScriptTypeResolver typeResolver,
        ...
        protected new string GetTypeNameHint()
        {
