...
namespace NJsonSchema.CodeGeneration.TypeScript.Models
{
    ...
    public class CustomClassTemplateModel : ClassTemplateModelBase
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="CustomClassTemplateModel" /> class.</summary>
        ...
        public CustomClassTemplateModel(string typeName, string discriminatorName,
            TypeScriptGeneratorSettings settings, CustomTypeScriptTypeResolver resolver,
            ...
            : base(resolver, schema, rootObject)
        {
            ...
            Properties = _schema.ActualProperties.Values
                ...
                .Select(property => new CustomPropertyModel(this, property, ClassName, _resolver, _settings))
                .ToList();
        }
        ...
        public List<CustomPropertyModel> Properties { get; }
